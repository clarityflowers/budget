...
//     [x] check headers
//     [x] sort by date
//     [x] make map of bank notes to transactions (one to many)
//   [ ] reshape external csv/tsv files
//     [ ] reorder columns
//     [ ] merge income/expenses
//     [ ] handle different date formats
//   [ ] load external data
//   [ ] match with existing data to throw out records
...
const TransactionLog = struct {
    ...
    pub fn load(stream: var, allocator: *Allocator) !@This() {
        var result = @This(){
